...
public class SideControlPanel : MonoBehaviour
{
    ...
    [SerializeField] private bool isSpongeBob;

    [SerializeField] private bool isDragonOceanGame;
    [SerializeField] private bool isOC2Ex;
    ...
    private void OnCLickFishStatsBtn()
    {
        if (isChasingWind)
            ...
            UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHSTATS_SPONGEBOB);
        else if (isOC2Ex)
            UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHSTATS_OC2EX);
