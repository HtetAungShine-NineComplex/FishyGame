...
public class UIRoomSelection_Octopus : UIBase
{
    ...
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHING_GAME_OCTOPUS);
        UIManager.Instance.CloseUI(GLOBALCONST.UI_ROOM_SELECT_OCTOPUS);
    }

    private void EnterRoom() //temp
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_LOADING);
        SceneLoader.Instance.LoadSceneAsync((int)SceneIndex.FISHING_GAME_SCENE_OCTOPUS, false);
    }
