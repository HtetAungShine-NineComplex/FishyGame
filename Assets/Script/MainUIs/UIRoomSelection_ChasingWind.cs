...
public class UIRoomSelection_ChasingWind : UIBase
{
    ...
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHING_GAME_CHASINGWIND);
        UIManager.Instance.CloseUI(GLOBALCONST.UI_ROOM_SELECT_CHASINGWIND);
    }

    private void EnterRoom() //temp
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_LOADING);
        SceneLoader.Instance.LoadSceneAsync((int)SceneIndex.FISHING_GAME_SCENE_CHASINGWIND, false);
    }
