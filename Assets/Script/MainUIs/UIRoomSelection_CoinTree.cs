...
public class UIRoomSelection_CoinTree : UIBase
{
    ...
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHING_GAME_COINTREE);
        UIManager.Instance.CloseUI(GLOBALCONST.UI_ROOM_SELECT_COINTREE);
    }

    private void EnterRoom() //temp
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_LOADING);
        SceneLoader.Instance.LoadSceneAsync((int)SceneIndex.FISHING_GAME_SCENE_COINTREE, false);
    }
