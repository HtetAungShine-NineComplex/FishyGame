...
public class UIRoomSelection_Buffalo : UIBase
{
    ...
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_FISHING_GAME_BUFFALO);
        UIManager.Instance.CloseUI(GLOBALCONST.UI_ROOM_SELECT_LIKUI);
    }

    private void EnterRoom() //temp
    {
        UIManager.Instance.ShowUI(GLOBALCONST.UI_LOADING);
        SceneLoader.Instance.LoadSceneAsync((int)SceneIndex.FISHING_GAME_SCENE_BUFFALO, false);
    }
